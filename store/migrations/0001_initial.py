# Generated by Django 4.1.7 on 2023-04-04 20:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slug', models.SlugField(blank=True, unique=True)),
                ('type', models.CharField(choices=[('hm', 'Hard Rock / Metal'), ('jz', 'Jazz'), ('rp', 'Rap'), ('cl', 'Classique'), ('el', 'Electro'), ('var', 'Variété')], max_length=100, verbose_name='Genre')),
                ('place', models.CharField(max_length=300, verbose_name='Salle de concert')),
                ('thumbnail', models.ImageField(upload_to='concerts')),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.artist', verbose_name='Artiste')),
                ('ticket', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='store.ticket')),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
